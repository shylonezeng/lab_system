	...
	$.fn.bxSlider = function(options){		
		...
		function initCss(){
			...
			// CSS for vertical mode
				...
				.wrap('<div class="bx-window" style="width:'+childrenMaxWidth+'px; height:'+wrapperHeight+'px; position:relative; "></div>')
				.css({
				  height: '999999px',
				  position: 'relative',
					top: '-'+(origTop)+'px'
			...
			// CSS for fade mode
				...
				$parent
				.wrap('<div class="'+options.wrapperClass+'" style="width:'+childrenMaxWidth+'px; position:relative;"></div>')
				.wrap('<div class="bx-window" style="height:'+childrenMaxHeight+'px; width:'+childrenMaxWidth+'px; position:relative; "></div>');
				$parent.children(options.childSelector).css({
				  listStyle: 'none',
				  position: 'absolute',
					top: 0,
